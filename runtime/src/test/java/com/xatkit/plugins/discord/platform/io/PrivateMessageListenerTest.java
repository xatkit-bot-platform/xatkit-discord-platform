...
import com.xatkit.plugins.discord.platform.DiscordTest;
import com.xatkit.plugins.discord.stubs.StubMessage;
import com.xatkit.plugins.discord.stubs.StubPrivateChannel;
import com.xatkit.plugins.discord.stubs.StubPrivateMessageReceivedEvent;
...
public class PrivateMessageListenerTest extends DiscordTest {
    ...
    public void setUp() {
        ...
        configuration.addProperty(DiscordUtils.DISCORD_TOKEN_KEY, getDiscordToken());
