...
Note that there is no changelog available for the initial release of the platform (2.0.0), you can find the release notes [here](https://github.com/xatkit-bot-platform/xatkit-discord-platform/releases).
...
See the release notes [here](https://github.com/xatkit-bot-platform/xatkit-discord-platform/releases).
